    ...
    return `
      ...
      <form class="container" novalidate>
            ...
            <div class="row mb-4 g-4 align-items-center">
                ...
                <div class="col-md-4">
                  <input type="tel" id="inputPhone" class="form-control" placeholder="Votre Téléphone" required>
                </div>
            </div>
            <div class="row g-4 align-items-center">
                ...
                <div class="col-4">
                  <input type="time" id="inputHeure" class="form-control" placeholder="Heure" required>
                </div>
                <div class="col-4">
                  <input type="number" id="inputEvent" class="form-control" placeholder="Nombre de personnes" min="1" required>
                </div>
                <div>
